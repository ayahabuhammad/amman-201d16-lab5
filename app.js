...
function multiplyAnyArray(dynamicArray) {
  let S=1;
  for(let j=0; j<testDynamicArray.length;j++){
    S=S * testDynamicArray[j];
  }
  return[S,'The numbers '+testDynamicArray[0]+','+testDynamicArray[1]+','+testDynamicArray[2]+','+testDynamicArray[3]+','+testDynamicArray[4]+' have a product of '+S+'.'];
  //eslint-disable-line
}
